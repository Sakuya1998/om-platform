...
const (
	PositionService_ListPosition_FullMethodName        = "/api.user.service.v1.PositionService/ListPosition"
	PositionService_GetPosition_FullMethodName         = "/api.user.service.v1.PositionService/GetPosition"
	PositionService_CreatePosition_FullMethodName      = "/api.user.service.v1.PositionService/CreatePosition"
	PositionService_UpdatePosition_FullMethodName      = "/api.user.service.v1.PositionService/UpdatePosition"
	PositionService_DeletePosition_FullMethodName      = "/api.user.service.v1.PositionService/DeletePosition"
	PositionService_BatchGetPosition_FullMethodName    = "/api.user.service.v1.PositionService/BatchGetPosition"
	PositionService_BatchCreatePosition_FullMethodName = "/api.user.service.v1.PositionService/BatchCreatePosition"
	PositionService_BatchDeletePosition_FullMethodName = "/api.user.service.v1.PositionService/BatchDeletePosition"
)
...
type PositionServiceClient interface {
	...
	// 批量获取职位
	BatchGetPosition(ctx context.Context, in *BatchGetPositionRequest, opts ...grpc.CallOption) (*BatchGetPositionResponse, error)
	// 批量创建职位
	BatchCreatePosition(ctx context.Context, in *BatchCreatePositionRequest, opts ...grpc.CallOption) (*BatchCreatePositionResponse, error)
	// 批量删除职位
	BatchDeletePosition(ctx context.Context, in *BatchDeletePositionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *positionServiceClient) BatchGetPosition(ctx context.Context, in *BatchGetPositionRequest, opts ...grpc.CallOption) (*BatchGetPositionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchGetPositionResponse)
	err := c.cc.Invoke(ctx, PositionService_BatchGetPosition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *positionServiceClient) BatchCreatePosition(ctx context.Context, in *BatchCreatePositionRequest, opts ...grpc.CallOption) (*BatchCreatePositionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchCreatePositionResponse)
	err := c.cc.Invoke(ctx, PositionService_BatchCreatePosition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *positionServiceClient) BatchDeletePosition(ctx context.Context, in *BatchDeletePositionRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, PositionService_BatchDeletePosition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PositionServiceServer interface {
	...
	// 批量获取职位
	BatchGetPosition(context.Context, *BatchGetPositionRequest) (*BatchGetPositionResponse, error)
	// 批量创建职位
	BatchCreatePosition(context.Context, *BatchCreatePositionRequest) (*BatchCreatePositionResponse, error)
	// 批量删除职位
	BatchDeletePosition(context.Context, *BatchDeletePositionRequest) (*emptypb.Empty, error)
...
func (UnimplementedPositionServiceServer) BatchGetPosition(context.Context, *BatchGetPositionRequest) (*BatchGetPositionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchGetPosition not implemented")
}
func (UnimplementedPositionServiceServer) BatchCreatePosition(context.Context, *BatchCreatePositionRequest) (*BatchCreatePositionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchCreatePosition not implemented")
}
func (UnimplementedPositionServiceServer) BatchDeletePosition(context.Context, *BatchDeletePositionRequest) (*emptypb.Empty, error) {
...
func _PositionService_BatchGetPosition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchGetPositionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PositionServiceServer).BatchGetPosition(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PositionService_BatchGetPosition_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PositionServiceServer).BatchGetPosition(ctx, req.(*BatchGetPositionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PositionService_BatchCreatePosition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchCreatePositionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PositionServiceServer).BatchCreatePosition(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PositionService_BatchCreatePosition_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PositionServiceServer).BatchCreatePosition(ctx, req.(*BatchCreatePositionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PositionService_BatchDeletePosition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchDeletePositionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PositionServiceServer).BatchDeletePosition(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PositionService_BatchDeletePosition_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PositionServiceServer).BatchDeletePosition(ctx, req.(*BatchDeletePositionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PositionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.user.service.v1.PositionService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BatchGetPosition",
			Handler:    _PositionService_BatchGetPosition_Handler,
		},
		{
			MethodName: "BatchCreatePosition",
			Handler:    _PositionService_BatchCreatePosition_Handler,
		},
		{
			MethodName: "BatchDeletePosition",
			Handler:    _PositionService_BatchDeletePosition_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/user/service/v1/position.proto",
}
